...
class CarState(object):
    ...
    def store(self, fileName,steerkey,gearkey,racekey):
        f = open(fileName, 'a')
        writer = csv.writer(f)

        data = []
        data.append(steerkey)
        data.append(gearkey)
        data.append(racekey)
        data.append(self.angle)
        data.append(self.curLapTime)
        data.append(self.damage)
        data.append(self.distFromStart)
        data.append(self.distRaced)
        data.append(self.focus)
        data.append(self.fuel)
        data.append(self.gear)
        data.append(self.lastLapTime)
        data.append(self.opponents)
        data.append(self.racePos)
        data.append(self.rpm)
        data.append(self.speedX)
        data.append(self.speedY)
        data.append(self.speedZ)
        data.append(self.track)
        data.append(self.trackPos)
        data.append(self.wheelSpinVel)
        data.append(self.z)
